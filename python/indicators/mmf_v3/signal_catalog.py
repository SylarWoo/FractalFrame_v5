...
MMF_V3_SIGNAL_CATALOG: dict[MmfV3SignalType, MmfV3SignalCatalogEntry] = {
    ...
    "MMF_V3_OVERBOUGHT": _entry("MMF_V3_OVERBOUGHT", label="overbought open", category="trend", direction="up", role="vdo_threshold_state", timing="current", layer="event", strategy_intent="overbought_watch", symbol="\u25c6", color="#ef5350", size=24, placement="above"),
    "MMF_V3_OVERBOUGHT_CLOSE": _entry("MMF_V3_OVERBOUGHT_CLOSE", label="overbought close", category="trend", direction="down", role="vdo_threshold_state_close", timing="current", layer="event", strategy_intent="overbought_close", symbol="\u25c7", color="#ef5350", size=24, placement="below"),
    "MMF_V3_OVERSOLD": _entry("MMF_V3_OVERSOLD", label="oversold open", category="trend", direction="down", role="vdo_threshold_state", timing="current", layer="event", strategy_intent="oversold_watch", symbol="\u25c6", color="#26a69a", size=24, placement="below"),
    "MMF_V3_OVERSOLD_CLOSE": _entry("MMF_V3_OVERSOLD_CLOSE", label="oversold close", category="trend", direction="up", role="vdo_threshold_state_close", timing="current", layer="event", strategy_intent="oversold_close", symbol="\u25c7", color="#26a69a", size=24, placement="above"),
