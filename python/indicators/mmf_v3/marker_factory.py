...
def create_marker(signal: StochStateSignal, settings: MmfV3Settings, classification: tuple[str, str] | None = None) -> MmfV3Marker:
    marker_type = "MMF_V3_HIGH" if signal.type == "high" else "MMF_V3_LOW"
...
def _create_reason(signal: StochStateSignal, settings: MmfV3Settings, classification: tuple[str, str] | None = None) -> tuple[str, ...]:
