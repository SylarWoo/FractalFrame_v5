...
import { cancelMt5M1CheckJob, fetchMt5M1CheckJob, fetchStoreV6Check, startMt5M1CheckJob } from '../../services/mt5/mt5SymbolsApi'
import type { Mt5M1CheckJobPayload, StoreV6CheckPayload, StoreV6PullJobPayload } from '../../services/mt5/mt5SymbolsApi'
import { delay } from '../mt5DataCenter/storeV6StatusFormat'
import { savePersistedM1CheckResult } from '../mt5DataCenter/storeV6Persistence'

type UseStoreV6M1CheckJobsOptions = {
...
export function useStoreV6M1CheckJobs({
  selectedRowSymbol,
  storeCheck,
  ...
  async function handleCheckMt5M1() {
    ...
    try {
      const payload = await fetchStoreV6Check(symbol)
